...
exports.load = load;
exports.useColors = useColors;
exports.destroy = require$$0.deprecate(
	() => {},
...
function log(...args) {
	return process.stderr.write(require$$0.format(...args) + '\n');
}
...
formatters.o = function (v) {
	...
	return require$$0.inspect(v, this.inspectOpts)
		.split('\n')
		.map(str => str.trim())
		.join(' ');
};
...
inherits(Parser, require$$2.EventEmitter);
...
var WritableStream = require$$0$1.Writable;
var StringDecoder = require$$1$1.StringDecoder;
var Buffer$1 = require$$2$1.Buffer;
...
var ReadableStream = require$$0$1.Readable,
    inherits = require$$0.inherits;
...
require$$0.inherits(DevNullStream, WritableStream);
...
var TransformStream = require$$0$1.Transform,
    inherits = require$$0.inherits;
