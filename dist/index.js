...
var require$$2$1 = require('buffer');
...
exports.load = load;
exports.useColors = useColors;
exports.destroy = require$$0__default['default'].deprecate(
	() => {},
...
function log(...args) {
	return process.stderr.write(require$$0__default['default'].format(...args) + '\n');
}
...
formatters.o = function (v) {
	...
	return require$$0__default['default'].inspect(v, this.inspectOpts)
		.split('\n')
		.map(str => str.trim())
		.join(' ');
};
...
inherits(Parser, require$$2__default['default'].EventEmitter);
...
function parseWithParse5 (content, isDocument) {
  var parse = isDocument ? lib$1.parse : lib$1.parseFragment,
      root = parse(content, { treeAdapter: lib$1.treeAdapters.htmlparser2 });
...
exports.evaluate = function(content, options, isDocument) {
  ...
  if (typeof content === 'string') {
    ...
    dom = useHtmlParser2 ? lib.parseDOM(content, options) : parseWithParse5(content, isDocument);
  } else {
    dom = content;
  }
...
var cloneDom = function(dom, options) {
  ...
  return parse$2(domSerializer(dom, options), options, false).children;
};
...
exports.load = function(content, options, isDocument) {
  ...
  var root = parse$2(content, options, isDocument);
...
var updateDOM = parse$2.update,
    evaluate = parse$2.evaluate,
    domEach = utils$1.domEach,
...
var Cheerio = module.exports = function(selector, context, root, options) {
  ...
  if (root) {
    if (typeof root === 'string') root = parse$2(root, this.options, false);
  ...
  if (typeof selector === 'string' && isHtml(selector)) {
    return Cheerio.call(this, parse$2(selector, this.options, false).children);
  }
  ...
  if (!context) {
    ...
    if (isHtml(context)) {
      // $('li', '<ul>...</ul>')
      context = parse$2(context, this.options, false);
...
var _from$1 = "cheerio";
var _id$1 = "cheerio@1.0.0-rc.3";
var _inBundle$1 = false;
var _integrity$1 = "sha512-0td5ijfUPuubwLUu0OBoe98gZj8C/AA+RW3v67GPlGOrvxWjZmBXiBCRU+I8VEiNyJzjth40POfHiz2RB3gImA==";
var _location$1 = "/cheerio";
...
var _resolved$1 = "https://registry.npmjs.org/cheerio/-/cheerio-1.0.0-rc.3.tgz";
var _shasum$1 = "094636d425b2e9c0f4eb91a46c05630c9a1a8bf6";
var _spec$1 = "cheerio";
var _where$1 = "/Users/sammyrobens-paradise/projects/github-contributions-counter";
var author$1 = {
	name: "Matt Mueller",
...
var homepage$1 = "https://github.com/cheeriojs/cheerio#readme";
var keywords$1 = [
	"htmlparser",
	"jquery",
	"selector",
